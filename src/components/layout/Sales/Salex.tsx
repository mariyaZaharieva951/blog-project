const Sales = () => {
    return (
      <div className="custom-container flex lg:flex-row gap-12 flex-col lg:justify-center border-t-2 border-gray-dark font-custom-font lg:pt-10 pb-12">
        <div className="lg:w-[487px] min-w-[350px] mx-auto lg:mx-0 lg:h-auto flex flex-col items-start lg:pr-5 px-3 lg:px-0 mt-12">
        ...
        <div className="lg:w-[555px] min-w-[350px] flex mx-auto lg:mx-0 lg:h-[555px] h-auto relative px-2 lg:px-0">
