...
const Introduction = () => {
  return (
    <div className=" flex lg:w-[1180px] lg:flex-row flex-col lg:mx-auto mx-2 relative mt-7 pt-7 pb-5 gap-1">
    <div className="flex flex-col lg:items-start items-center font-custom-font w-full lg:w-max-[639px]">
