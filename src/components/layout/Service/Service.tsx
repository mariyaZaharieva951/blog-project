const Service = () => {
    return (
      <div className="custom-container flex lg:flex-row gap-12 flex-col lg:justify-between border-t-2 border-gray-dark font-custom-font lg:pt-10 pb-12">
        <div className="lg:w-[487px] mx-auto lg:mx-0 lg:h-auto flex flex-col items-start pr-5 mt-12 lg:px-0 px-2">
        ...
        <div className="lg:w-[555px] flex mx-auto lg:mx-0 lg:h-[555px]">
