const Roooby = () => {
    return (
        <div className="font-custom-font lg:text-start text-center mx-auto lg:mx-0">
            <h3 className="text-2xl font-bold">Roooby</h3>
            <p className="text-sm my-3 leading-5 px-7 lg:px-0">We built an elegant solution. 
